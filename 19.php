    ...
    <div class="secondblock">
		...
		if ($dejagagne== 0){ ?>
			...
			<form action="verifreponse.php" method="POST">
				...
				<input type="text" name="reponse" id="reponse" value ="<?php if(isset($_GET['reponse'])){ echo $_GET['reponse']; } 	?>" class="inputreply">
...
<footer>
	...
	<p><a href="secret.php?uuid=<?php echo $_GET['uuid'];?>&trouve=oui" class="secrect">secret</p>
</footer>
</html>
<?php
